...
class Tuning(_message.Message):
    ...
    desired_cadence_high: int
    desired_cadence_low: int
    def __init__(self, nominal_gear_encoder_value_1: _Optional[int] = ..., nominal_gear_encoder_value_2: _Optional[int] = ..., nominal_gear_encoder_value_3: _Optional[int] = ..., nominal_gear_encoder_value_4: _Optional[int] = ..., nominal_gear_encoder_value_5: _Optional[int] = ..., nominal_gear_encoder_value_6: _Optional[int] = ..., desired_cadence_high: _Optional[int] = ..., desired_cadence_low: _Optional[int] = ...) -> None: ...
